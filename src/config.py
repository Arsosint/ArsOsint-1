# -*- coding UTF-8 -*-
# ArsOsint НИКАК НЕ УЧАСТВУЕТ В СОХРАНЕНИИ ПОЛЬЗОВАТЕЛЬСКИХ ДАННЫХ!.
...
def print_banner() -> None:
    ...
    print(F'{COLOR_CODE["RED"]}{COLOR_CODE["BOLD"]}* Мы в Телеграме: {COLOR_CODE["RESET"]}{COLOR_CODE["LI_G"]}{https://t.me/+bcHl7TpfUopjYTMy["SOFT_ORIGINAL_CHANNEL"]}{COLOR_CODE["RESET"]}')
    print(F'{COLOR_CODE["RED"]}{COLOR_CODE["BOLD"]}*  ссылка на Ориг: {COLOR_CODE["RESET"]}{COLOR_CODE["LI_G"]}{GLOBAL_SOFT_INFO["SOFT_ORIGINAL_LINK"]}{COLOR_CODE["RESET"]}')
