...
if __name__ == "__main__":
    ...
    while True:
        ...
        print(f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[1] {COLOR_CODE["LI_G"]}'
            f'чекнуть {COLOR_CODE["RED"]}Номерочек{COLOR_CODE["LI_G"]} телефона.{COLOR_CODE["RESET"]}\n'
            ...
            f'чекнуть {COLOR_CODE["RED"]}IP{COLOR_CODE["LI_G"]} телефона.{COLOR_CODE["RESET"]}\n'

            f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[4] {COLOR_CODE["LI_G"]}'
            f'чекнуть {COLOR_CODE["RED"]}Гос. номерочек{COLOR_CODE["LI_G"]} автомобиля.{COLOR_CODE["RESET"]}\n'
